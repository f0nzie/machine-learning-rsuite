...
> Needs spark server. Installed but not responding.
Removing OpenJDK 11 and installing instead Java 8
...
```{r eval=FALSE}
# PCA demo
# https://www.rdocumentation.org/packages/h2o/versions/3.22.1.1/topics/h2o.prcomp
...
australia.pca <- h2o.prcomp(training_frame = australia, 
                            k = 8, 
...
```{r deep-learning-model, echo=FALSE}
